...
En especial el primer i l'últim article. Recomanem que no llegiu l'article de Mayer fins al final de l'informe.
...
D'entrada podem veure que el dataset té 10 caraterístiques de les quals tres són categòriques i la majoria són quantitatives.
...
Pel què fa a les dimensions, tenim x, y, z, table, depth i carat. x, y i z són les dimensions màximes/externes del diamant i taula i profunditat les mínimes/internes.

La [imatge 1](#dimensions) il·lustra bé les dimensions. I finalment el pes es mesura en carats.

[]{#dimensions}

<center>
![Imatge 1: Explicació de les dimensions d'un diamant](images/diamonds.png)
</center>

La variable que més estudiarem serà la del preu. De quines variables depèn més? Quines són poc rellevants? D'entrada podem fer una ullada a la distribució d'aquest preu [[Imatge 1](#distribucio)] i observar que la majoria de diamands es venen per menys de dos mil dòlars i que per sobre de cinc mil tenim una cua exponencialment decreixent amb poca freqüència que s'allarga fins a 18000 US$. En general la corba és exponencial decreixent amb un petit *plateau* de dos mil a cinc mil.
...
Per a fer-ho dibuixarem la distribució del preu condicionada per la variable categòrica i també el diagrama de caixes per veure la mediana, els quantiles i els valors més extrems (que, amb la distribució dels preus de l'anàlisi preliminar, ja podem anticipar que seràn a la part més cara del gràfic).
