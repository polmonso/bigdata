...
La shapefile per seccions és massa granularitzada: les seccions conformen els districtes. Quan fem el mapa les unirem.
...
La majoria de la població no ha passat a estudis superiors. Per sort, el tant per cent de gent que no ha estat escolaritzada és força baix, tot i que segueix sent massa tenint en compte que l'educació secundària és obligatòria.
...
Com era d'esperar, l'edat mitja està força uniformament repartida entre els districtes. Tot i que potser podríem trobar una certa preferència a la perifèria a mida que augmenta l'edat.

Com que l'edat està força uniformament repartida, l'anàlisi del nivell d'estudis no es veurà gaire esbiaixat per la distribució d'edat.
...
-   *10 LLICENCIAT O GRAU UNIVER.* 11 NI LLEGIR NI ESCRIURE 12 NO
    APLICABLE MENOR 16 13 PRIMÀRIA INCOMPLETA 14 SENSE ESTUDIS
...
Podem observar una diferència notable entre els districtes 2, 4 i 5 en comparació als altres. Potser la presència de la zona universitària al districte 2 decanta la balança cap als estudis superiors. 

En la visualització en forma de mapa podem observar que els districtes entre 35-40 % no són al voltant del districte universitari. Caldria buscar altres variables per a explicar les diferències entre districtes que queden fora de l'abast d'aquest exercici.